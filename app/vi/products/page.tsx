  ...
  const filteredProducts = useMemo(() => {
    ...
    return [...products].sort((a, b) => {
      switch (sortBy) {
        ...
        case 'name':
        default:
          return (a.name_vi || a.name_en).localeCompare(b.name_vi || b.name_en);
      }
    });
        ...
        <div className="bg-dark-800 border-b border-white/5">
          <div className="container mx-auto px-4 py-8">
            ...
            <p className="text-slate-400 mt-2">
              Khám phá bộ sưu tập {filteredProducts.length} peptide nghiên cứu
            </p>
          </div>
        </div>
...
export default function ProductsPageVI() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-dark-900 flex items-center justify-center text-white">Đang tải...</div>}>
      <ProductsContentVI />
    </Suspense>
  );
}
