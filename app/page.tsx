            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mt-16 flex flex-wrap justify-center gap-8 text-white/60 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span>&gt;98% Purity Guaranteed</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Browse our extensive collection of research peptides organized by category
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
              <div>
                ...
                <p className="text-gray-600 mt-2">Top selling research peptides from our catalog</p>
              </div>
              <Link
                href="/products"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white/90 text-sm mb-6">
                ...
                <span>Quick & Secure Ordering</span>
              </div>

              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to Order?</h2>
              <p className="text-xl text-white/70 mb-10">
                Contact us via Telegram for quick ordering and secure crypto payment options.
              </p>
        ...
        <section className="py-6 bg-amber-50 border-y border-amber-100">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-center gap-3 text-amber-800">
              ...
              <p className="text-sm">
                <strong>Research Use Only:</strong> {t('disclaimer', locale)}
              </p>
            </div>
          </div>
        </section>
